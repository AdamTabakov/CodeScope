...
const DynamicText = ({ className }: { className?: string }) => {
  ...
  return (
    <section
      ...
      className={cn("flex min-h-[200px] items-center justify-center gap-1 p-4", className)}
    >
        ...
        {isAnimating ? (
          <AnimatePresence mode="popLayout">
            <motion.div
              ...
              aria-live="off"
              className="absolute flex items-center gap-2 font-normal text-2xl text-[var(--text)]"
          ...
          <div className="flex items-center gap-2 font-normal text-2xl text-[var(--text)]">
            <div
              aria-hidden="true"
              className="h-2 w-2 rounded-full bg-[var(--green)]"
            />

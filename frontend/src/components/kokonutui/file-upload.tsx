...
const UploadIllustration = () => (
  <div className="relative h-16 w-16">
    ...
    >
      ...
      <path
        className="fill-[var(--primary-glow)] stroke-[var(--cyan)]"
...
export default function FileUpload({
  ...
  return (
    <div
      ...
      role="complementary"
    >
      <div className="group relative w-full rounded-xl bg-[var(--card)] p-0.5 ring-1 ring-[var(--border)]">
        <div className="absolute inset-x-0 -top-px h-px w-full bg-gradient-to-r from-transparent via-[var(--primary-glow)] to-transparent" />

        <div className="relative w-full rounded-[10px] bg-[var(--surface)]/60 p-1.5">
          <div
            className={cn(
              "relative mx-auto w-full overflow-hidden rounded-lg border border-[var(--border)] bg-[var(--card)]",
          ...
          >
            ...
            >
              <div className="absolute inset-x-0 top-0 h-[20%] bg-gradient-to-b from-[var(--primary-glow)] to-transparent" />
              <div className="absolute inset-x-0 bottom-0 h-[20%] bg-gradient-to-t from-[var(--primary-glow)] to-transparent" />
              <div className="absolute inset-y-0 left-0 w-[20%] bg-gradient-to-r from-[var(--primary-glow)] to-transparent" />
              <div className="absolute inset-y-0 right-0 w-[20%] bg-gradient-to-l from-[var(--primary-glow)] to-transparent" />
              <div className="absolute inset-[20%] animate-pulse rounded-lg bg-[var(--primary-glow)] transition-all duration-300" />
            </div>

            <div className="absolute -top-4 -right-4 h-8 w-8 bg-gradient-to-br from-[var(--primary-glow)] to-transparent opacity-0 blur-md transition-opacity duration-500 group-hover:opacity-100" />
                ...
                {status === "idle" || status === "dragging" ? (
                  ...
                  >
                    ...
                    <div className="mb-4 space-y-1.5 text-center">
                      <h3 className="text-lg tracking-tight text-[var(--text)]">
                        Drag and drop or
                      </h3>
                    ...
                    <button
                      className="group flex w-4/5 items-center justify-center gap-2 rounded-full bg-[var(--primary)] px-4 py-2.5 text-sm text-[var(--text-on-primary)] transition-all duration-200 hover:bg-[var(--primary-hover)]"
                  ...
                  >
                    ...
                    <div className="mb-4 space-y-1.5 text-center">
                      <h3 className="truncate text-sm text-[var(--text)]">
                        {file?.name}
                      </h3>
                    ...
                    <button
                      className="flex w-4/5 items-center justify-center gap-2 rounded-full bg-[var(--primary)] px-4 py-2.5 text-sm text-[var(--text-on-primary)] transition-all duration-200 hover:bg-[var(--primary-hover)]"
                      onClick={resetState}
                      type="button"
                    >
                      Cancel
            ...
            <AnimatePresence>
              {error && (
                <motion.div
                  ...
                  className="absolute bottom-4 left-1/2 -translate-x-1/2 transform rounded-lg border border-[var(--red)]/20 bg-[var(--red)]/10 px-4 py-2"
                  exit={{ opacity: 0, y: -10 }}
                  initial={{ opacity: 0, y: 10 }}
                >
